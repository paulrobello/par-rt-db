...
- **Fine-grained subscription invalidation** — `get(id)` point reads skip re-runs when the write didn't touch their document; every other shape stays table-level (#21).
