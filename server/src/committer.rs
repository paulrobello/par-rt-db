...
//! `RunMigrate`, `RunReaper` — plus `RunRestoreSchema` and `RunMergeUsers`,
//! and publishes each at the four tap sites (subscription fan-out, op-feed,
//! audit log, webhooks). Never add a second writer.
