...
| FEATURE_MATRIX | Row in `FEATURE_MATRIX.md` §1 ("At parity today") or §2 (ranked gap matrix, #1–#26) |
...
| --- | --- | --- | --- | --- |
| `2026-07-21-par-rt-db-design.md` | Implemented (MVP server + expansions) | 2026-07-21 (server); see expansions below | §1 (all rows) + §2 (#1–#26) | All specs below are follow-ons |
