...
par-rt-db ships five client SDKs — TypeScript, Rust, Python, Swift, and Go — that
...
| Go | `github.com/paulrobello/par-rt-db/go-client` | [`go-client/`](../go-client) | [`go-client/README.md`](../go-client/README.md) |
...
Six implementations of one protocol must stay byte-identical —
...
[`swift-client/Sources/ParRtDbClient/Wire.swift`](../swift-client/Sources/ParRtDbClient/Wire.swift), and
[`go-client/wire/`](../go-client/wire)
(serde tags and field names — the casing is deliberately non-uniform and
load-bearing). Two mechanisms keep them honest:

- **Any server behavior change must be mirrored in all five clients** — wire
...
- **The [`wire-corpus/`](../wire-corpus/README.md) semantics corpus** — every
  case is executed by all six runners (the live server plus the five
